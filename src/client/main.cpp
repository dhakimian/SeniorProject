...
void render()
{
    ...
    if( g_targ_Follow_Rotation )
        diff_ang = Angle_pl - g_Angle_targ;
    else
    ...
    if( g_targ_Follow_Rotation )
        g_rotVel_targ = rotVel_pl + diff_ang/rotDeccel_targ;
    else
        g_rotVel_targ = 0 + diff_ang/rotDeccel_targ;
    ...
    diff_x = xPos_pl - g_xPos_cam;
    diff_y = yPos_pl - g_yPos_cam;
                    ...
                    if( e.type == SDL_KEYDOWN )
                    {
                        switch( e.key.keysym.sym ) {
                            ...
                            case SDLK_p:
                                ...
                                //It lowers the g_players health if you press the K key     
                            case SDLK_k:
                                g_players[player]->takeDamage(10);
                                break;
                                //case SDLK_8:
                                //SOUND_ON = !SOUND_ON;
                                //break;
                            ...
                            case SDLK_0:    
                                ...
                                break;
                            case SDLK_3:    
                                g_players[player]->weapons_upgrade(); 
                                break;
